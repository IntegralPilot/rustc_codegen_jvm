...
| **[Network](tests/binary/network/src/main.rs)** | Loopback TCP and UDP, DNS, timeouts, nonblocking sockets, peeking, vectored I/O, multicast, cloning, shutdown, and socket options. |
