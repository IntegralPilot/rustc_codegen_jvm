...
fn generate_metadata(jar_path: &PathBuf, output_path: &PathBuf) -> Result<usize, String> {
    // --- Configurable ---
    let target_class_name_internal = "org/rustlang/core/Core"; // Assumed convention
    ...
    for method in &parsed_class.methods {
        ...
        // --- Filter for shims (adjust if needed) ---
        ...
        if is_public && is_static {
            ...
            // Key is the method name found in the class file
            shim_map.insert(
